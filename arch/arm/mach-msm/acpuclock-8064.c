...
static struct msm_bus_paths bw_level_tbl[] __initdata = {
	...
	[8] = BW_MBPS(5000), /* At least 625 MHz on bus. */
};
...
static struct l2_level l2_freq_tbl_oc4[] __initdata = {
	...
	[14] = { { 1431000, HFPLL, 1, 0x35 }, 1200000, 1200000, 7 },
	{ }
};
...
static struct l2_level l2_freq_tbl_oc5[] __initdata = {
	...
	[12] = { { 1026000, HFPLL, 1, 0x26 }, 1150000, 1150000, 7 },
	[13] = { { 1188000, HFPLL, 1, 0x2C }, 1175000, 1175000, 7 },
	[14] = { { 1512000, HFPLL, 1, 0x38 }, 1200000, 1200000, 7 },
	{ }
};

static struct l2_level l2_freq_tbl_oc6[] __initdata = {
	[0]  = { {  384000, PLL_8, 0, 0x00 },  950000, 1050000, 1 },
	[1]  = { {  432000, HFPLL, 2, 0x20 }, 1050000, 1050000, 2 },
	[2]  = { {  486000, HFPLL, 2, 0x24 }, 1050000, 1050000, 2 },
	[3]  = { {  540000, HFPLL, 2, 0x28 }, 1050000, 1050000, 2 },
	...
	[12] = { { 1026000, HFPLL, 1, 0x26 }, 1150000, 1150000, 7 },
	[13] = { { 1188000, HFPLL, 1, 0x2C }, 1175000, 1175000, 7 },
	[14] = { { 1620000, HFPLL, 1, 0x3C }, 1200000, 1200000, 8 },
	{ }
};
...
static struct acpu_level tbl_PVS0_1512MHz[] __initdata = {
	...
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(9),  1087500 },
	...
	{ 1, {  2160000, HFPLL, 1, 0x4F }, L2(14), 1350000 },
...
static struct acpu_level tbl_PVS1_1512MHz[] __initdata = {
	...
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(9),  1037500 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(9),  1050000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(9),  1087500 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(9),  1112500 },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(14), 1150000 },
	{ 1, {  1620000, HFPLL, 1, 0x3C }, L2(14), 1200000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(14), 1237500 },
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(14), 1250000 },
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(14), 1262500 },
	{ 1, {  1944000, HFPLL, 1, 0x48 }, L2(14), 1287500 },
	{ 1, {  1998000, HFPLL, 1, 0x4A }, L2(14), 1312500 },
	{ 1, {  2052000, HFPLL, 1, 0x4C }, L2(14), 1325000 },
	{ 1, {  2106000, HFPLL, 1, 0x4E }, L2(14), 1350000 },
	{ 1, {  2160000, HFPLL, 1, 0x4F }, L2(14), 1375000 },
	{ 1, {  2214000, HFPLL, 1, 0x50 }, L2(14), 1400000 },
	{ 1, {  2268000, HFPLL, 1, 0x52 }, L2(14), 1400000 },
	{ 1, {  2322000, HFPLL, 1, 0x54 }, L2(14), 1400000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS2_1512MHz[] __initdata = {
	...
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(9),  1012500 },
	...
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(14), 1237500 },
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(14), 1250000 },
	{ 1, {  1944000, HFPLL, 1, 0x48 }, L2(14), 1262500 },
	{ 1, {  1998000, HFPLL, 1, 0x4A }, L2(14), 1287500 },
	{ 1, {  2052000, HFPLL, 1, 0x4C }, L2(14), 1312500 },
	{ 1, {  2106000, HFPLL, 1, 0x4E }, L2(14), 1325000 },
	{ 1, {  2160000, HFPLL, 1, 0x4F }, L2(14), 1350000 },
	{ 1, {  2214000, HFPLL, 1, 0x50 }, L2(14), 1375000 },
	{ 1, {  2268000, HFPLL, 1, 0x52 }, L2(14), 1400000 },
	{ 1, {  2322000, HFPLL, 1, 0x54 }, L2(14), 1400000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS3_1512MHz[] __initdata = {
	...
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(9),   987500 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(9),  1000000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(9),  1037500 },
...
static struct acpu_level tbl_PVS4_1512MHz[] __initdata = {
	...
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(14), 1050000 },
	{ 1, {  1620000, HFPLL, 1, 0x3C }, L2(14), 1075500 },
	...
	{ 1, {  2160000, HFPLL, 1, 0x4F }, L2(14), 1275000 },
	{ 1, {  2214000, HFPLL, 1, 0x50 }, L2(14), 1300000 },
...
static struct acpu_level tbl_PVS5_1512MHz[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(5),   900000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),   925000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(9),   937500 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(9),   950000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(9),   975000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(9),  1000000 },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(14), 1025000 },
	{ 1, {  1620000, HFPLL, 1, 0x3C }, L2(14), 1050000 },
	...
	{ 1, {  2214000, HFPLL, 1, 0x50 }, L2(14), 1287500 },
...
static struct acpu_level tbl_PVS6_1512MHz[] __initdata = {
	...
	{ 1, {  2160000, HFPLL, 1, 0x4F }, L2(14), 1237500 },
...
static int __init acpuclk_8064_probe(struct platform_device *pdev)
{
	...
	if (opt_bin == 6) {
		acpuclk_8064_params.l2_freq_tbl = l2_freq_tbl_oc6;
		acpuclk_8064_params.l2_freq_tbl_size = sizeof(l2_freq_tbl_oc6);
	}
