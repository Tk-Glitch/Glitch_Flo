...
static struct acpu_level tbl_PVS0_1512MHz[] __initdata = {
	...
	{ 1, {  1944000, HFPLL, 1, 0x48 }, L2(14), 1312500 },
	{ 1, {  1998000, HFPLL, 1, 0x4A }, L2(14), 1337500 },
	{ 1, {  2052000, HFPLL, 1, 0x4C }, L2(14), 1362500 },
	{ 1, {  2106000, HFPLL, 1, 0x4E }, L2(14), 1400000 },
	{ 1, {  2214000, HFPLL, 1, 0x52 }, L2(14), 1437500 },
	{ 1, {  2268000, HFPLL, 1, 0x54 }, L2(14), 1450000 },
	{ 1, {  2322000, HFPLL, 1, 0x56 }, L2(14), 1475000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS1_1512MHz[] __initdata = {
	...
	{ 1, {  2268000, HFPLL, 1, 0x54 }, L2(14), 1425000 },
	{ 1, {  2322000, HFPLL, 1, 0x56 }, L2(14), 1450000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS2_1512MHz[] __initdata = {
	...
	{ 1, {  2268000, HFPLL, 1, 0x54 }, L2(14), 1387500 },
	{ 1, {  2322000, HFPLL, 1, 0x56 }, L2(14), 1425000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS3_1512MHz[] __initdata = {
	...
	{ 1, {  2268000, HFPLL, 1, 0x54 }, L2(14), 1350000 },
	{ 1, {  2322000, HFPLL, 1, 0x56 }, L2(14), 1400000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS4_1512MHz[] __initdata = {
	...
	{ 1, {  2268000, HFPLL, 1, 0x54 }, L2(14), 1325000 },
	{ 1, {  2322000, HFPLL, 1, 0x56 }, L2(14), 1370000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS5_1512MHz[] __initdata = {
	...
	{ 1, {  2268000, HFPLL, 1, 0x54 }, L2(14), 1300000 },
	{ 1, {  2322000, HFPLL, 1, 0x56 }, L2(14), 1350000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS6_1512MHz[] __initdata = {
	...
	{ 1, {  2268000, HFPLL, 1, 0x54 }, L2(14), 1275000 },
	{ 1, {  2322000, HFPLL, 1, 0x56 }, L2(14), 1325000 },
	{ 0, { 0 } }
};
...
static struct pvs_table pvs_tables[NUM_SPEED_BINS][NUM_PVS] __initdata = {
	...
	[1][1] = { tbl_PVS1_1700MHz, sizeof(tbl_PVS1_1700MHz),     50000 },
	[1][2] = { tbl_PVS2_1700MHz, sizeof(tbl_PVS2_1700MHz),     50000 },
	[1][3] = { tbl_PVS3_1700MHz, sizeof(tbl_PVS3_1700MHz),     50000 },
	[1][4] = { tbl_PVS4_1700MHz, sizeof(tbl_PVS4_1700MHz),     50000 },
	[1][5] = { tbl_PVS5_1700MHz, sizeof(tbl_PVS5_1700MHz),     50000 },
	[1][6] = { tbl_PVS6_1700MHz, sizeof(tbl_PVS6_1700MHz),     50000 },

	[2][0] = { tbl_PVS0_2000MHz, sizeof(tbl_PVS0_2000MHz),     0 },
	[2][1] = { tbl_PVS1_2000MHz, sizeof(tbl_PVS1_2000MHz),     50000 },
	[2][2] = { tbl_PVS2_2000MHz, sizeof(tbl_PVS2_2000MHz),     50000 },
	[2][3] = { tbl_PVS3_2000MHz, sizeof(tbl_PVS3_2000MHz),     50000 },
	[2][4] = { tbl_PVS4_2000MHz, sizeof(tbl_PVS4_2000MHz),     50000 },
	[2][5] = { tbl_PVS5_2000MHz, sizeof(tbl_PVS5_2000MHz),     50000 },
	[2][6] = { tbl_PVS6_2000MHz, sizeof(tbl_PVS6_2000MHz),     50000 },

	[14][0] = { tbl_PVS0_1512MHz, sizeof(tbl_PVS0_1512MHz),     0 },
	[14][1] = { tbl_PVS1_1512MHz, sizeof(tbl_PVS1_1512MHz),     50000 },
	[14][2] = { tbl_PVS2_1512MHz, sizeof(tbl_PVS2_1512MHz),     50000 },
	[14][3] = { tbl_PVS3_1512MHz, sizeof(tbl_PVS3_1512MHz),     50000 },
	[14][4] = { tbl_PVS4_1512MHz, sizeof(tbl_PVS4_1512MHz),     50000 },
	[14][5] = { tbl_PVS5_1512MHz, sizeof(tbl_PVS5_1512MHz),     50000 },
	[14][6] = { tbl_PVS6_1512MHz, sizeof(tbl_PVS6_1512MHz),     50000 },
};
